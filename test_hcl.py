...
"""
    # header_text = page.get_by_text("Welcome to Operations").text_content()
    # header_text = page.locator("h2", has_text="Welcome").text_content()

    # below one also works if the h2 is only element in entire page
    # header_text = page.locator("h2").text_content()

    # the below one cmd will works since only
    header_text = page.get_by_role("heading").text_content()
    # header_text = page.get_by_role("heading",name="Operations").text_content()
"""


# class Testing_Page:
#
#     def test_operation_tab(self, page: Page):
#         page.goto("file:///C:/Users/HP/Downloads/InstanceTest.html")
#
#         # heading text
#         header_text = page.locator("h2", has_text="Welcome").text_content()
#         print("The Header text is {}".format(header_text))
#         time.sleep(3)
#
#         # paragraph text
#         para_text = page.locator("p", has_text="dashboard").text_content()
#         print("The paragraph text is {}".format(para_text))
#         time.sleep(3)
#         self.test_ProvTab(page)
